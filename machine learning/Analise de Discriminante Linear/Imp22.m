...
a_c_1 = zeros(size(A_com,2),1);%variável de alocação de dados em novo espaço de 1 dimensão
...
%% Métricas da função de discriminante linear (Teste)
...
%% Variação de Limiar dos dados de treinamento

%valores de y_c
figure
histogram((y_c),50,'Normalization','probability');
hold on
histogram((y_s),50,'Normalization','probability');
title('Histograma de valores da base de treinamento no espaço W')
...
%% Métricas dos dados de teste para o melhor limiar
